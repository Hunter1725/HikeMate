...
import com.example.hikemate.WeatherForecast.Model.DailyWeatherResponse;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private TextView txtDate, txtTemp, txtWind, txtHumidity, txtMaxMin, txtWeatherDes, txtWeatherRecommend, txtDay1, txtDay2, txtDay3, txtDay4, txtTempDay1,
            txtTempDay2, txtTempDay3, txtTempDay4, txtRainForecast, txtDayTip, txtDayRecommend, txtEmpty, txtLocation;
    ...
    private Button btnRequestGPS, btnChange;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent != null) {
            ...
            if (incomingLatlng != null) {
                ...
                getWeatherData(incomingLatlng.latitude, incomingLatlng.longitude);
    ...
    private void getNameLocation(LatLng latLng) {
        txtLocation.setText(reverseGeocodeAddress(latLng));
    }
