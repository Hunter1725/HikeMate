...
public class ChatActivity extends AppCompatActivity implements NetworkUtils.OnConnectivityChangeListener{
    ...
    public static final String GUIDE_STRING = "I wanna you to act as a Hiking Expert and answer the following question based on their language (limit to 80 words): \n";
    ...
    private void callAPI(String question) {
        ...
        Request request = new Request.Builder()
                ...
                .header("Authorization","Bearer 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")
                .post(body)
                .build();
